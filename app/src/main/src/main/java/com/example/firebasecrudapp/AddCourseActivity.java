...
public class AddCourseActivity extends AppCompatActivity {
    ...
    private TextInputEditText courseNameEdt, courseDescEdt, coursePriceEdt, bestSuitedEdt;
...
//                String courseLink = (courseLinkEdt.getText()).toString();
                ...
                CourseRVModal courseRVModal = new CourseRVModal(courseID, courseName, courseDesc, coursePrice, bestSuited);
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        startActivity(new Intent(AddCourseActivity.this, MainActivity.class).putExtra("isAdmin", isAdmin));
                    }
